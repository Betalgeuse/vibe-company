...
**4.2 vibe-company 클론 실행**
```bash
git clone https://github.com/Betalgeuse/vibe-company.git

# 출력:
# Cloning into 'vibe-company'...
...
> 💡 **바이브코딩 입문자라면?**  
> 클론 완료 후 바로 [Junior AX Playbook](../../README.md)으로 이동하세요!
