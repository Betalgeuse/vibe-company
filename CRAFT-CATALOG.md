...
```bash
# 1. 컨텍스트 제공
"indie hacker를 위한 SEO 자동화 도구 아이디어 검증하고 싶어"
...
```bash
# 1. 컨텍스트 제공
"이 논문을 코드로 구현하고 싶어: https://arxiv.org/abs/xxxx"
...
```bash
# 1. 컨텍스트 제공
"biz-idea로 아이디어 검증하고, research-idea로 레퍼런스 찾고, MVP 스펙 만들어줘"
...
```bash
# 1. 먼저 컨텍스트 제공
"1인 개발자를 위한 자동 배포 도구 아이디어 검증하고 싶어"
